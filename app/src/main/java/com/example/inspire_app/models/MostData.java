...
public class MostData {
    ...
    public MostData(List<String> allcomment, String _id, String category, String content, String organization, String socialmedia, String imageurl, int __v, Boolean comments) {
